    ...
    <DndProvider backend={HTML5Backend}>
      ...
      <div className="flex h-full overflow-hidden bg-bg">
        ...
        <div
          ...
          style={{ backgroundColor: settings.canvasTheme === 'light' ? '#f0e6d8' : '#0d0c17' }}
        >
          <div style={{ width: canvasW * canvasScale, height: canvasH * canvasScale, flexShrink: 0 }}>
            <div
              ...
              style={{
                width: canvasW,
                height: canvasH,
                backgroundImage: settings.canvasTheme === 'light' ? 'url(/bg-light.jpg)' : 'url(/bg.jpg)',
            ...
            >
              ...
              {layout !== "thumbnail" && settings.showPresentedBy && (
                <div className="flex flex-col items-end justify-center shrink-0" style={{ gap: '4px', paddingRight: `${settings.sitePadding}px`, paddingBottom: `${settings.sitePadding}px` }}>
                  <div style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 700, fontSize: '14px', letterSpacing: '1px', color: settings.canvasTheme === 'light' ? 'rgba(26,27,42,0.5)' : 'rgba(255,255,255,0.5)' }}>
                    PRESENTED BY
                  </div>
