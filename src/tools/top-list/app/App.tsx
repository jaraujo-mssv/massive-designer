    ...
    try {
      ...
      const dataUrl = await domToJpeg(element, {
        ...
        onCloneNode: (cloned: Node) => {
          if (cloned instanceof HTMLElement && cloned.id === 'top-list-export-area' && bgDataUrl) {
    ...
    <DndProvider backend={HTML5Backend}>
      ...
      <div className="flex h-full overflow-hidden bg-bg">
        ...
        <div
          ...
          className={`flex-1 flex items-center justify-center overflow-hidden canvas-${settings.canvasTheme}`}
          style={{ backgroundColor: '#0d0c17' }}
        >
          <div style={{ width: canvasW * canvasScale, height: canvasH * canvasScale, flexShrink: 0 }}>
            <div
              id="top-list-export-area"
              ref={canvasRef}
              style={{
                width: canvasW,
                height: canvasH,
            ...
            >
              ...
              {layout !== "thumbnail" && settings.showPresentedBy && (
                <div className="flex flex-col items-end justify-center shrink-0" style={{ gap: '4px', paddingRight: `${settings.sitePadding}px`, paddingBottom: `${settings.sitePadding}px` }}>
                  <div style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 700, fontSize: '14px', letterSpacing: '1px', color: 'var(--canvas-text-dim)' }}>
                    PRESENTED BY
                  </div>
